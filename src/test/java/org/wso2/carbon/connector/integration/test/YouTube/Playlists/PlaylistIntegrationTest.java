...
public class PlaylistIntegrationTest extends ESBIntegrationTest {
    ...
    protected void cleanup() {
        axis2Client.destroy();
          ...
          /*Test Playlists */
/*
    @Test(groups = {"wso2.esb"}, description = "YouTube{PlaylistList} integration test.")
    public void testPlaylistListtWithMandatory() throws Exception {
        ...
        String methodName = "PlaylistList";
        ...
        try {
            ...
            proxyAdmin.deleteProxy(methodName);
             ...
             /*Test PlaylistsInsert */
/*
    @Test(groups = {"wso2.esb"}, description = "YouTube{PlaylistInsert} integration test.")
    public void testPlaylistInserttWithMandatory() throws Exception {
        ...
        String methodName = "PlaylistsInsert";
        ...
        try {
            ...
            proxyAdmin.deleteProxy(methodName);
             ...
             /*Test Playlists Update */
/*
    @Test(groups = {"wso2.esb"}, description = "YouTube{PlaylistUpdate} integration test.")
    public void testPlaylistUpdatetWithMandatory() throws Exception {
        ...
        String methodName = "PlaylistsUpdate";
        ...
        try {
            ...
            proxyAdmin.deleteProxy(methodName);
             ...
             /*Test Playlists Delete */

    @Test(groups = {"wso2.esb"}, description = "YouTube{PlaylistDelete} integration test.")
    public void testPlaylistDeletetWithMandatory() throws Exception {
        ...
        String methodName = "PlaylistsDelete";
