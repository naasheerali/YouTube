...
//
//    @Test(groups = {"wso2.esb"}, description = "YouTube{GuideCategoriesListPartSnippetAndMine} integration test.")
//    public void testGuideCategoriesListWithMandatoryParametersSnippetMine() throws Exception {
//
...
//    }
//
//              /*Test GuideCategoriesList With invalid Mandatory Parameters Invalid snippet*/
//
//    @Test(groups = {"wso2.esb"}, description = "YouTube{GuideCategoriesListPartInvalidSnippetAndMine} integration test.")
//    public void testGuideCategoriesListWithInvalidIdMandatoryParametersSnippeteAndMine() throws Exception {
//
//        String jsonRequestFilePath = pathToRequestsDirectory + "GuideCategories/GuideCategoriesListSnippetMine.txt";
//        String methodName = "GuideCategoriesList";
//
