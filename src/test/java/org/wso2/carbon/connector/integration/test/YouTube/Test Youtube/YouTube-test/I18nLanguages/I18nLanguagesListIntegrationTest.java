...
public class I18nLanguagesListIntegrationTest extends ESBIntegrationTest {
    ...
    /*Test I18nLanguages With valid Mandatory Param and hl*/

    @Test(groups = {"wso2.esb"}, description = "YouTube{I18nLanguagesWithValidMandatory} integration test.")
    public void testI18nLanguagesWithValidMandatoryParameter() throws Exception {

        String jsonRequestFilePath = pathToRequestsDirectory + "I18nLanguages/i18nLanguagesListMandatory.txt";
        String methodName = "i18nLanguagesList";
        ...
        String modifiedJsonString = String.format(jsonString, YouTubeConnectorProperties.getProperty("apiUrl"),
                ...
                YouTubeConnectorProperties.getProperty("i18nLanguagesListPart"),
                YouTubeConnectorProperties.getProperty("i18nLanguagesListhl"));
   ...
   /*Test I18nLanguages With invalidvalid mandatory*/

    @Test(groups = {"wso2.esb"}, description = "YouTube{I18nLanguagesWithInvalidMandatory} integration test.")
    public void testI18nLanguagesWithInvalidMandatoryParameter() throws Exception {

        String jsonRequestFilePath = pathToRequestsDirectory + "I18nLanguages/i18nLanguagesListInvalidMandatory.txt";
        String methodName = "i18nLanguagesList";
        ...
        String modifiedJsonString = String.format(jsonString, YouTubeConnectorProperties.getProperty("apiUrl"),
                ...
                YouTubeConnectorProperties.getProperty("grant_type"),
                YouTubeConnectorProperties.getProperty("refresh_token"),
                YouTubeConnectorProperties.getProperty("i18nLanguagesListInvalidPart"));
    ...
    /*Test I18nLanguages With invalidvalid optional*/

    @Test(groups = {"wso2.esb"}, description = "YouTube{I18nLanguagesWithInvalidOptional} integration test.")
    public void testI18nLanguagesWithInvalidOptionalParameter() throws Exception {

        String jsonRequestFilePath = pathToRequestsDirectory + "I18nLanguages/i18nLanguagesListInvalidOptional.txt";
        String methodName = "i18nLanguagesList";
        ...
        String modifiedJsonString = String.format(jsonString, YouTubeConnectorProperties.getProperty("apiUrl"),
                ...
                YouTubeConnectorProperties.getProperty("refresh_token"),
                YouTubeConnectorProperties.getProperty("i18nLanguagesListPart"),
                YouTubeConnectorProperties.getProperty("i18nLanguagesListInvalidhl"));
